<div class="page-header">
    <h2 class="header-title">Actualizar Operador</h2>
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            <a href="<?php echo base_url(); ?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Inicio</a>
            <a class="breadcrumb-item" href="<?php echo base_url("users") ?>">Usuarios</a>
            <span class="breadcrumb-item active">Actualizar Operador</span>
        </nav>
    </div>
</div>
<div class="card">
    <div class="card-body">
        ...
        <div class="m-t-25">
            ...
            <form action="<?php echo base_url("users/update_operator/") . $user['user_id'] ?>" method="post" autocomplete="off">
                    ...
                    <?php if ($this->session->userdata('is_admin') == 1): ?>
                        <div class="form-group col-lg-6">
                            ...
                            <select class="form-control" name="supervisor">
                                <option value="0" <?php echo ($user['supervisor'] == 0) ? 'selected' : ''; ?> >Operador</option>
                                <option value="1" <?php echo ($user['supervisor'] == 1) ? 'selected' : ''; ?>>Supervisor</option>
                            </select>
                        </div>
                    <?php endif; ?>
