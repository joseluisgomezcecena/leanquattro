...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url("andons/solve/" . $andon['id_andon']) ?>" method="post">
                <div class="row">
                    ...
                    <div class="form-group col-lg-12 mt-5">
                        ...
                        <textarea class="form-control" name="solution_comment" id="service_comment" rows="5" required></textarea>
                    </div>
                
                    <div class="form-group col-lg-12 mt-5">
                        <button class="btn btn-success float-right btn-lg" name="solve" type="submit">Solucionar</button>
                    </div>
                </div>
            </form>
        </div>
