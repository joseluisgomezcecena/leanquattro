<div class="page-header">
    ...
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            ...
            <span class="breadcrumb-item active">Activar Orden De Trabajo</span>
        </nav>
    </div>
</div>

<form action="<?php echo base_url("hourbyhour/activate/" . $work_order_id) ?>" method="post">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4>Orden de trabajo a activar</h4>
                <button type="submit" name="activate" class="btn btn-primary">Activar</button>
                <div class="m-t-25">
                        <div class="row">
                            <div class="col-lg-12">
                                <p>Se activara la orden de trabajo  para la estación de trabajo: <b> <?php echo $work_order['work_station_name']; ?></b> </p>
