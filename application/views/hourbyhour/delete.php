...
<form action="<?php echo base_url("hourbyhour/delete/" . $work_order_id) ?>" method="post">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4>Orden de trabajo a Eliminar</h4>
                <button type="submit" name="delete" class="btn btn-danger">Eliminar</button>
                <div class="m-t-25">
                        <div class="row">
                            <div class="col-lg-12">
                                <p>Se eliminara la orden de trabajo  para la estación de trabajo: <b> <?php echo $work_order['work_station_name']; ?></b> </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Estas por eliminar una orden de trabajo, esto eliminara la planeacion y el avance de la orden.
                <b>¿Estas seguro de querer continuar? Esta acción no se puede deshacer.</b>
                <br><br/>
