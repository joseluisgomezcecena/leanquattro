            ...
            <form action="<?php echo base_url("screens/create") ?>" method="post">
                <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="screen_name" name="screen_name" placeholder="Nombre de la pantalla" value="<?php echo set_value('screen_name'); ?>">
                    ...
                    <div class="form-group col-lg-8" >
                        ...
                        <input type="text" class="form-control" id="description" name="screen_description" placeholder="Descripción corta" value="<?php echo set_value('screen_description'); ?>">
