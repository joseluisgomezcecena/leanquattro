<div class="page-header">
    <h2 class="header-title">Crear Linea De Producción</h2>
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            <a href="<?php echo base_url(); ?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Inicio</a>
            <a class="breadcrumb-item" href="#">Lineas De Producción</a>
            <span class="breadcrumb-item active">Crear Linea De Producción</span>
        </nav>
    </div>
</div>

<form action="<?php echo base_url("productionlines/create") ?>" method="post" enctype="multipart/form-data">
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
