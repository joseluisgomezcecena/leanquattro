<div class="page-header">
    <h2 class="header-title">Actualizar Linea De Producción</h2>
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            <a href="<?php echo base_url(); ?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Inicio</a>
            <a class="breadcrumb-item" href="#">Lineas De Producción</a>
            <span class="breadcrumb-item active">Actualizar Linea De Producción</span>
        </nav>
    </div>
</div>

<form action="<?php echo base_url("productionlines/update/" . $line['line_id']) ?>" method="post" enctype="multipart/form-data">
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="line_name" name="line_name" placeholder="Nombre de la linea de producción" value="<?php echo $line['line_name']; ?>">
