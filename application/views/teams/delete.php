<div class="page-header">
    <h2 class="header-title">Eliminar Equipo</h2>
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            <a href="<?php echo base_url(); ?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Inicio</a>
            <a class="breadcrumb-item" href="<?php echo base_url("teams") ?>">Equipos</a>
            <span class="breadcrumb-item active">Eliminar Equipo</span>
        </nav>
    </div>
</div>
<div class="card">
    <div class="card-body">
        ...
        <div class="m-t-25">
            ...
            <form action="<?php echo base_url("teams/delete/" . $team['team_id']) ?>" method="post">
                <div class="row">
                    
                    <div class="form-group col-lg-4">
                        <label for="team_name">Nombre del equipo</label>
                        <input type="text" class="form-control" id="team_name" name="team_name" placeholder="Nombre del equipo" value="<?php echo $team['team_name']; ?>" disabled>
                    ...
                    <div class="form-group col-lg-8" >
                        ...
                        <input type="text" class="form-control" id="description" name="team_description" placeholder="Descripción corta" value="<?php echo $team['team_description']; ?>" disabled >
                    ...
                    <div class="form-group col-lg-4" >
                        ...
                        <div class="m-b-15">
                            <select class="select2" name="leader" disabled>
                    ...
                    <div class="form-group col-lg-8" >
                        ...
                        <div>
                            <select class="select2" name="member_id[]" multiple="multiple" disabled>
                                <option value="">Seleccione</option>
                                <?php foreach ($users as $user) { ?>
                    ...
                    <div class="form-group col-lg-6" >
                        ...
                        <select class="select2" name="team_plant" id="plant_id" disabled>
                            <option value="">Seleccione</option>
                    ...
                    <div class="form-group col-lg-6" >
                        ...
                        <select class="select2" name="team_line[]" id="line_id" multiple="multiple" disabled>
                            <option value="">Seleccione</option>
                    ...
                    <div class="form-group col-lg-12 mb-5" >
                        ...
                        <select class="select2" name="alert_id[]" multiple="multiple" disabled>
                            <option value="">Seleccione</option>
                    ...
                    <div class="form-group col-lg-3" >
                        ...
                        <div class="form-group d-flex align-items-center">
                            <div class="switch m-r-10">
                                <input type="checkbox" id="switch-1" name="escalation_1" <?php echo ($team['escalation_1'] == 1) ? "checked" : ""; ?> disabled>
                    ...
                    <div class="form-group col-lg-3" >
                        ...
                        <div class="form-group d-flex align-items-center">
                            <div class="switch m-r-10">
                                <input type="checkbox" id="switch-2" name="escalation_2" <?php echo ($team['escalation_2'] == 1) ? "checked" : ""; ?> disabled>
                    ...
                    <div class="form-group col-lg-3" >
                        ...
                        <div class="form-group d-flex align-items-center">
                            <div class="switch m-r-10">
                                <input type="checkbox" id="switch-3" name="escalation_3" <?php echo ($team['escalation_3'] == 1) ? "checked" : ""; ?> disabled>
                    ...
                    <div class="form-group col-lg-3" >
                        ...
                        <div class="form-group d-flex align-items-center">
                            <div class="switch m-r-10">
                                <input type="checkbox" id="switch-4" name="escalation_4" <?php echo ($team['escalation_4'] == 1) ? "checked" : ""; ?> disabled>
