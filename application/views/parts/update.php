...
<form action="<?php echo base_url("parts/update/" . $part['pn_id']) ?>" method="post" enctype="multipart/form-data">
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                    ...
                    <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" class="form-control" id="part_number" name="part_number" placeholder="Numero de parte" value="<?php echo $part['part_number']; ?>">
                            ...
                            <div class="form-group col-lg-12" >
                                ...
                                <textarea type="text" class="form-control" id="part_description" name="part_description" rows="8" placeholder="Descripción"><?php echo $part['part_description']; ?></textarea>
